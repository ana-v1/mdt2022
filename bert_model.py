...
class Bert_Classifier(torch.nn.Module):
    def __init__(self, freeze_bert=False, input_shape=(768, 50, 6)):
...
def train(model, train_dataloader, val_dataloader=None, epochs=3, batch_size=32, verbose=False, evaluation=False):
    ...
    for epoch_i in range(epochs):
        ...
        torch.save(bert_classifier, f'./bert_model_epoch_{epoch_i}_acc_{val_accuracy}.pt')
...
if __name__ == "__main__":
    ...
    torch.save(bert_classifier, './bert_model.pt')